...
public:
    ...
    void addInterest() {
        ...
        recordTransaction(TransactionIDGenerator::generateTransactionID(), "Interest", interestAmount, "Interest added");
    }
...
public:
    ...
    void deductTDS() {
        ...
        withdraw(tdsAmount);
        recordTransaction(TransactionIDGenerator::generateTransactionID(), "TDS", tdsAmount, "TDS deducted");
    }
