...
#if 0
add 2 user for online transaction using webSocket
#endif
...
public:
    // zero balance inherit
    // linked account
    // maturity check when withdrawl
